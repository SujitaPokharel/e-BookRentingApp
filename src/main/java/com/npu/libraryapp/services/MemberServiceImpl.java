...
public class MemberServiceImpl implements MemberService {
	...
	public Member findMemberDetails(String title) {
		...
		System.out.println("Details of the Member for given name is : [ Name: "
				...
				+ memberDao.findMemberByName(title).getMemid() + ", Member Address: "
				+ memberDao.findMemberByName(title).getAddress() + ", Member Classification: "
	...
	public String findMemberNameById(int memid) {
		...
		System.out.println("Name of the Member with given Id is : " + memberDao.findMemberNameById(memid));
		return name;
	}
