...
<body>
	...
	<h1>
		<fmt:message key="memberDataForm.title" />
	</h1>

	<form:form action="./processNewSignUpProfile" method="POST"
		commandName="member">
		<table>
			<tr>
			...
			<tr>
				...
				<td><form:radiobutton path="classification" value="Grad"
						checked="true" /> Grad<br> <form:radiobutton
						path="classification" value="Undergrad" /> Undergrad<br> <form:radiobutton
						path="classification" value="Faculty" /> Faculty<br></td>
			</tr>
